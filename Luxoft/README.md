...
так как департамент Digital Marketing еще только планировался
топ-менеджементом. Они начали поиск кандидатов заранее,
...
продолжаю поддерживать связь с топ-менеджером (Сергей Карась).
